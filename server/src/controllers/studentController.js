...
function isCourseAccessible(course, assignedCourseIds) {
...
export async function getCourses(req, res, next) {
  try {
    ...
    const payload = courses.map((course) => {
      const accessible = isCourseAccessible(course, assignedCourseIds);
...
export async function getLesson(req, res, next) {
  try {
    ...
    const accessible = lesson.isFree || isCourseAccessible(course, assignedCourseIds);
